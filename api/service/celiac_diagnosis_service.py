...
from api.models.celiac_patient_model import (
    CeliacPatient,
    CeliacPatientEncoded,
    ModelResponse,
    ModelEnum,
    DiagnoseDescriptionEnum,
)


class CeliacDiagnosisService:
    ...
    def predict_celiac_diagnosis_logistic_regression(self, patient_data: CeliacPatient):
        # encode the data
        ...
        return ModelResponse(
            ...
            diagnose_description=(
                DiagnoseDescriptionEnum.CELIAC
                if prediction[0] == 0
                else DiagnoseDescriptionEnum.NON_CELIAC
            ),
